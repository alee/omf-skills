# ABM Specification (Guidance Template)
...
<Detailed description of the world/grid, its properties, and how agents interact with it.>

## Scheduling and Execution
<Precise definition of the update order (e.g., synchronous, asynchronous, random) and time-step duration.>

## Interaction Protocols
<Detailed rules for communication and interaction between agents or between agents and the environment.>
