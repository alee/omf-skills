...
- **Specialist execution skills** — `document` (ODD/ODD+2 narrative generation after the OMFA handoff gate), `peer-review` (submission assessment), and future analysis skills for calibration, sensitivity analysis, and experimentation.
