...
- `artifacts/conceptual-model.md` — entities, processes, and system boundaries.
- `artifacts/assumptions.md` — scientific assumptions that implementation must preserve.
- `artifacts/implementation/plan.md` — any existing plan, when resuming work.

## Output

OMFB creates or updates `artifacts/implementation/plan.md`.
