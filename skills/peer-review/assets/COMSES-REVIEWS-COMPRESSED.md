...
This review rubric checks whether a computational model is reusable and publishable with baseline software engineering and documentation quality, aligned with FAIR principles, FAIR4RS recommendations, and frictionless reuse goals.
